...
public class Domain {
    ...
    public static boolean isValidDomain(String address) {
        for (String s : domains) {
            if (address.toLowerCase().endsWith(s)) {
                return true;
            } else if (address.toLowerCase().contains(s) && address.toLowerCase().contains("/")) {
                return true;
            }
        }
        return false;
